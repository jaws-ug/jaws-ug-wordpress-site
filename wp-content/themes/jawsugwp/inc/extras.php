 ...
 * facebook_app_id
 */
function jawsugwp_facebook_app_id() {
	if ( ! is_front_page() )
		return;
	$appid = get_theme_mod( 'facebook_app_id', 1400003920114272 );
?>
<div id="fb-root"></div>
<script>(function(d, s, id) {
  ...
  js.src = 'https://connect.facebook.net/ja_JP/sdk.js#xfbml=1&version=v2.11&appId=<?php echo esc_attr( $appid ); ?>';
  fjs.parentNode.insertBefore(js, fjs);
}(document, 'script', 'facebook-jssdk'));</script>
<?php
}
add_action( 'jawsugwp_before_body', 'jawsugwp_facebook_app_id' );